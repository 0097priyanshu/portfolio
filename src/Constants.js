import AUTOMATION from "./assets/projects/artisan.png";
import COAST from "./assets/projects/medigo.png";
import DROPSHIP from "./assets/projects/dataset.png";
import GOOD_FOOD_DISCOUNTS from "./assets/priyanshu.png";
import GUAMEDIA from "./assets/priyanshu.png";
import HSP from "./assets/priyanshu.png";
import COSMOS from "./assets/priyanshu.png";
import TECHSPEC from "./assets/priyanshu.png";
import TRAVELWELL from "./assets/priyanshu.png";
...
export const SKILLS = [
  {
    category: "Languages",
    items: ["C++", "C", "Python", "Java", "SQL (MySQL)", "JavaScript"],
  },
  {
    category: "Data & Analytics",
    items: ["Pandas", "NumPy", "Excel", "Basic Statistics", "Data Visualization"],
  },
  {
    category: "Developer Tools",
    items: ["Git & GitHub", "AWS", "GCP", "Power BI", "Tableau", "Cursor", "Figma"],
  },
  {
